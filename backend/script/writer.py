...
stock = f"<오늘의 주식> {get_stock('005930')[0]}시 기준 {get_stock('005930')[1]}원\n"
...
covid_confirm_case = f'<코로나 확진자 수> {get_covid_confirm_case()["update_time"]} {get_covid_confirm_case()["total_case"]}명입니다.\n'
